  ...
  return <div className="h-full overflow-y-auto bg-gray-50">
      <div className="p-4 space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-1">Monic Auditya A</h2>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          return <div key={index} className="bg-white rounded-xl p-4 text-center">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {achievements.map((achievement, index) => <div key={index} className={`p-4 rounded-xl border-2 ${achievement.earned ? 'bg-white border-green-200' : 'bg-gray-50 border-gray-200'}`}>
        ...
        <div>
          ...
          <div className="space-y-2">
            {friends.map((friend, index) => <div key={index} className="flex items-center justify-between p-3 bg-white rounded-lg">
