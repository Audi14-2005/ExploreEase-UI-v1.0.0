...
const ProfileScreen = () => {
  const achievements = [
    { title: 'Explorer', description: 'Visited 8 countries', icon: '🌍', earned: true },
    { title: 'Adventurer', description: 'Completed 25 trips', icon: '🎒', earned: true },
    { title: 'Navigator', description: 'Created 50 routes', icon: '🧭', earned: false },
    { title: 'Globetrotter', description: 'Travel 10,000km', icon: '✈️', earned: false }
  ];

  const friends = [
    { name: 'Sarah M.', trips: 12, avatar: '👩‍💼' },
    { name: 'John D.', trips: 8, avatar: '👨‍💻' },
    { name: 'Emily R.', trips: 15, avatar: '👩‍🎨' }
  ];

  const stats = [
    { label: 'Countries', value: '8', icon: MapPin, color: 'text-green-500' },
    { label: 'Trips', value: '23', icon: Plane, color: 'text-blue-500' },
    { label: 'Distance', value: '12.5k km', icon: Trophy, color: 'text-purple-500' },
    ...
    <div className="h-full overflow-y-auto bg-gray-50">
      <div className="p-4 space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-1">Alex Thompson</h2>
